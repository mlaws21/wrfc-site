...
function Donate() {
    return (
        <div>
            <p id="dtitle">If you would like to donate to the team please venmo @Matt-Laws-11.</p>
            ...
            <p id="dnote">*Money donated will go to a myriad of things including equipment, hosting this website,
